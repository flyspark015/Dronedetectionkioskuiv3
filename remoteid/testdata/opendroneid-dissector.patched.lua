...
dis:add(wtap_encaps["IEEE_802_11_RADIOTAP"],odid_protocol)
dis:add(wtap_encaps["IEEE_802_11_WITH_RADIO"],odid_protocol)
dis:add(wtap_encaps["IEEE_802_11_PRISM"],odid_protocol)
